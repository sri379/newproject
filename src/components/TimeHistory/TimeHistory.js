...
const TimeHistory = ({ timeRecords }) => {
  const navigate = useNavigate();
    ...
    const handleShowAllEmployeeTimeHistory = () => {
        // You can modify this to filter and display all employee time records
    ...
    return (
        <div>
            ...
            <button className='time-in' onClick={handleGenerateTimeHistory}>Generate Time History</button>&nbsp;&nbsp;&nbsp;
            <button  className='time-in'onClick={handleShowAllEmployeeTimeHistory}>All Employee Time History</button>&nbsp;&nbsp;&nbsp;
            <button  className='time-in'onClick={handleGenerateMonthWiseReport}>Month-Wise Report</button>
